## GRADİENT BOOSTİNG Eğitim Doğruluğu 0.9872340425531915
...
model = GradientBoostingClassifier(random_state=17).fit(X_train,y_train)

y_pred_train = model.predict(X_train)
y_pred_test = model.predict(X_test)

print("Eğitim Doğruluğu",accuracy_score(model.predict(X_train),y_train))
